...
Code Review runs against supported local coding-agent CLIs or configured model providers. Provider capabilities and safe execution defaults are maintained in the [compatibility source](../compatibility/providers.json) and validated before review work starts.
